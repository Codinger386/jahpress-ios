...
- (void)audioStreamerFailedToPlayStreamWithCodec:(NSString*)codec;
- (void)audioStreamerDetectedDifferentCodec:(NSString*)codec;
- (void)audioStreamerDetectedBitrate:(NSString*)bitrate;
- (void)audioStreamerUpdatedMetaData:(NSString*)metaData;

- (void)audioStreamerUpdatedICYName:(NSString*)icyName;
- (void)audioStreamerUpdatedICYURL:(NSString*)icyURL;

- (void)audioStreamerRedirectsToURL:(NSURL*)url;
- (void)audioStreamerNetworkError:(int)reason message:(NSString*)message;
...
@interface AudioStreamer : NSObject
{
    ...
    AudioQueueProcessingTapRef audioQueueTap;
...
@property (nonatomic, copy) NSMutableData *metaDataString;
@property (nonatomic, retain) NSString *streamContentType;

- (id)initWithURL:(NSURL *)aURL andCodec:(NSString*)codec andBitrate:(int)bitRate;
- (void)start;
- (void)stop;
- (void)pause;
- (BOOL)isPlaying;
